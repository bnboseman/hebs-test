...
[
    {
        ...
        "first_name": "Bertha",
        "last_name": "Kihn",
        "email": "dustin.jenkins@gibson.com",
        "address": "806 Aufderhar Cliff\nLake Maiaside, KY 96130",
    ...
    },
    {
        ...
        "first_name": "Irving",
        "last_name": "Schulist",
        "email": "dedrick.emard@heidenreich.org",
        "address": "24625 Anjali Pine\nTaraport, TN 36175-8105",
        "job_title": "Nuclear Power Reactor Operator",
        "posts": [
            {
                "userId": 2,
                "id": 11,
...
```json
{
    ...
    "first_name": "Dane",
    "last_name": "Wolff",
    "email": "melba.rosenbaum@gmail.com",
    "address": "6246 Hodkiewicz Roads Suite 899\nWest Robynton, NC 60022-4008",
    "job_title": "Assembler",
    "posts": [
        {
            "userId": 1,
...
#Quote
<!-- START_c2bc029d29c280cef40d1e2da2ea61d8 -->
## Retrieves random quote from https://api.kanye.rest/

> Example request:

```bash
curl -X GET -G "http://localhost/api/quote" 
```
...
<!-- END_c2bc029d29c280cef40d1e2da2ea61d8 -->
